...
def intercept_zepros_file(url):
    ...
    with sync_playwright() as p:
        ...
        def handle_response(response):
            # On cherche l'URL qui contient le slug de l'article sur le domaine zepros
            if slug in response.url and "zepros.fr" in response.url and not state["captured"]:
...
if __name__ == "__main__":
    target_url = "https://bati.zepros.fr/-nous-sommes-prets-pour-la-reprise-avec-nos-fournisseurs-et-nos-clients-v-adam-swiss-krono--87550"
    intercept_zepros_file(target_url)